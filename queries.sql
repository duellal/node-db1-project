...
select * customers where postalcode='1010'

-- Find the phone number for the supplier with the id 11
select * customers where supplierid=11

-- List first 10 orders placed, sorted descending by the order date
SELECT * FROM orders where orderdate <= '1996-07-16' order by orderdate desc limit 10
